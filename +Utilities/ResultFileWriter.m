...
%     writetable(t3, fullResultFileName, 'Delimiter', '\t');
    ...
    cell2 = cell(1,n);
    cell2(1, 1:phaseFramesNumColumns) = {'start_frame' 'hold_position' 'ramus_mandible' 'hyoid_burst' 'ues_closure' 'at_rest' 'end_frame' 'si_point1_x' 'si_point1_y' 'si_point2_x' 'si_point2_y' 'pixelspercm' 'frameRate' 'holdarea' 'lvc_onset' 'lvc_offset' 'laryngeal_jump' 'ues_opening'};

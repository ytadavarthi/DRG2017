function varargout = mygetline(varargin)
...
if (length(varargin) < 1)
    ...
    if (~ishghandle(varargin{1}))
        ...
        error(message('images:getline:expectedHandle'));
    end
    ...
    otherwise
        CleanUp(xlimorigmode,ylimorigmode);
        error(message('images:getline:expectedFigureOrAxesHandle'));
    end
end
...
case 'trap'
    ...
    error(message('images:getline:interruptedMouseSelection'));

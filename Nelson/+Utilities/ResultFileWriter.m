...
%     writetable(t3, fullResultFileName, 'Delimiter', '\t');
    ...
    cell2(1, 1:phaseFramesNumColumns) = {'start_frame' 'hold_position' ...
                                        ...
                                        'pcr_min_area' 'pcr_max_area' 'pas' 'pas_classifiers';
};
    ...
    cell3(1, 1:phaseFramesNumColumns) =   {globalStudyInfo.start_frame,   ...
                        ...
                        globalStudyInfo.pas, ...
                        pas_coordinates_number(globalStudyInfo.pas_classifiers)};
...
function pasc = pas_coordinates_number(pas_coordinates)
    pasc = 0;

    if length(pas_coordinates) == 3
        pasc = pas_coordinates(1)*100 + pas_coordinates(2)*10 + pas_coordinates(3)*1 ;
    elseif length(pas_coordinates) == 2
        pasc = pas_coordinates(1)*100 + pas_coordinates(2)*10 + pas_coordinates(3)*1 ;
    elseif length(pas_coordinates) == 1
        pasc = pas_coordinates(1)*100 + pas_coordinates(2)*10 + pas_coordinates(3)*1 ;
    end
end